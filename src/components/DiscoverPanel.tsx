  ...
  return (
    <>
      <p className="brand-sub discover-lead">
        Drive-to nature loops with parking. Ranked for parks & reserves first,
        then climb, lights, and turns.
      </p>
      ...
      <form className="route-form" onSubmit={onSubmit}>
        ...
        >
          {busy ? 'Searching…' : 'Find nature runs'}
        </button>
      </form>
            ...
            {hits.map((hit, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span>
                    {hit.natureKind} · {hit.driveMiles.toFixed(1)} mi drive ·{' '}
                    {hit.parkingLabel}
                  </span>
                  <span>
